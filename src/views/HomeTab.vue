    ...
    <div class="stats">
      ...
      <div class="statsWrapper">
        <div @click="routeTo('/tracks')" class="statCard">
          ...
          <img
            style="opacity: 40%"
            src="@/assets/images/music_note.svg"
            alt=""
          />
        </div>
        <div @click="routeTo('/albums')" class="statCard">
          ...
          <p>Albums</p>
          <img style="opacity: 40%" src="@/assets/images/album.svg" alt="" />
        </div>
...
<script>
import MixCard from "@/components/HomeTabComponents/MixCard.vue";
import { mapMutations, mapActions, mapState } from "vuex";
import { MixGenerator } from "@/Utils/FrontEndUtils/MixGenerator";
export default {
  components: { MixCard },
  computed: {
