...
import { BingDownloadManagerState, BingPendingTrack, BingTrackDownloadProgress, BingTrackStatePayload, BingTrackURLPayload } from "@/types/FLBing/BingTypes";
import { states } from "./TrackState";
...
const mutations = {
    ...
    setTrackDownloadURL(state: BingDownloadManagerState, payload: BingTrackURLPayload) {
